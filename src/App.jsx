...
{/* Toggle button directly under the photo box */}
<div className="image-switch-container fade-in">
  <div className="image-switch">
    <span className="switch-emoji">🍕</span>
    <span className="switch-label" style={{ color: showFirst ? 'var(--accent)' : 'var(--gray-300)' }}>
      BEFORE
    </span>
  ...
  <p className="switch-description">
    <span className="switch-highlight">96kg → 76kg.</span> Built by someone who lived it. Flip the switch to see the transformation that started hungrX.
  </p>
</div>
        </div>
      </div>
